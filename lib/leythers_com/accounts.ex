defmodule LeythersCom.Accounts do
  @moduledoc """
  ...
  alias LeythersCom.Accounts.{User, UserNotifier, UserToken}
  ...
  See `LeythersCom.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `LeythersCom.Accounts.User.password_changeset/3` for a list of supported options.
  ...
  3. The user has not confirmed their email but a password is set.
     ...
     source of security pitfalls. In this case we reject the magic link
     and return an error so the caller can fail gracefully.
  """
